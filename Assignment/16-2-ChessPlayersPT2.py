...
def get_player_by_country(lines):
    ...
    for line in lines:
        num, name, country, rating, year = line.split("; ")
        last_name, first_name, = name.split(", ")
        full_name = f"{first_name} {last_name}"
...
def get_player_by_year(lines):
    ...
    for line in lines:
        ...
        last_name, first_name, = name.split(", ")
        full_name = f"{first_name} {last_name}"
        d[year].append((full_name, int(rating)))
    return d

def print_players_by_year(players_by_country):
    print(s := "players by birth year:")
    print("-" * len(s))
...
def main():
    ...
    print()
    players_by_year = get_player_by_year(lines)
    print_players_by_year(players_by_year)
